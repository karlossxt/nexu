...
function roadMatches(expected, resolved) {
  ...
  // Si ambos lados tienen códigos de ruta, resolvemos primero la identidad
  // numérica. Esto evita que 45 coincida con 450 o 57 con 57D por substring.
  ...
  // Para nombres sin código permitimos inclusión solo en límites de token.
  // "Periférico Sur" puede coincidir con una forma ampliada por palabras,
  // pero nunca con "Periférico Sureste".
  if (containsTokenPhrase(a,b) || containsTokenPhrase(b,a)) return true;
